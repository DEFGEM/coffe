#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/home/defgem/.antigravity/extensions/wallabyjs.console-ninja-1.0.534-universal/out/buildHook/index.js').default({tool: 'react-native', checkSum: '20f5005f90c80a30aaf004UwMeARtXDQpUAVZSAwVZVVYABgVQ', mode: 'build', condition: true}); } catch(cjsError) { try { import('file:///home/defgem/.antigravity/extensions/wallabyjs.console-ninja-1.0.534-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'react-native', checkSum: '20f5005f90c80a30aaf004UwMeARtXDQpUAVZSAwVZVVYABgVQ', mode: 'build', condition: true})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
...
const expoStart = async (argv)=>{
    ...
    const { installEventLogger, getWellKnownTemporaryLogFile } = await Promise.resolve().then(()=>/*#__PURE__*/ _interop_require_wildcard(require("../events/index.js")));
